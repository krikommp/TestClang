...
namespace TestUU
{
    public static class Program
    {
        public static int Main()
        {
            // Assembly test =
            //     Assembly.LoadFrom(
            //         @"E:\UnrealEngine\Engine\Plugins\BlackjackSharp\Binaries\DotNET\BlackjackSharp.BuildTool\BlackjackSharp.BuildTool.dll");
            //
            // test?.GetType("UnrealEngine.BuildTool")?.GetMethod("TestMain")
            //     ?.Invoke(null, null);
            ...
            test?.GetType("ClassLibrary1.Class1")?.GetMethod("Test")
                ?.Invoke(null, null);
            return 0;
        }
    }
